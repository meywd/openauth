...
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">Record</code><code class="symbol">&lt;</code><code class="primitive">string</code><code class="symbol">, </code>[<code class="type">v1.StandardSchema</code>](https://github.com/standard-schema/standard-schema)<code class="symbol">&gt;</code>
</InlineSection>
</Section>
