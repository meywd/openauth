...
```ts
resolveLocalizedString(value,locale,fallbackLocale?)
```
</Section>
<Section type="parameters">
#### Parameters
- <p><code class="key">value</code> <code class="primitive">undefined</code><code class="symbol"> | </code>[<code class="type">LocalizedString</code>](#localizedstring)</p>
The localized string (string or Record<locale, string>)
- <p><code class="key">locale</code> <code class="primitive">string</code></p>
The locale to resolve for
- <p><code class="key">fallbackLocale?</code> <code class="primitive">string</code></p>
Fallback locale if primary not found (default: "en")
</Section>
<InlineSection>
**Returns** <code class="primitive">undefined</code><code class="symbol"> | </code><code class="primitive">string</code>
</InlineSection>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">string</code><code class="symbol"> | </code><code class="primitive">Record</code><code class="symbol">&lt;</code><code class="primitive">string</code><code class="symbol">, </code><code class="primitive">string</code><code class="symbol">&gt;</code>
</InlineSection>
</Section>
...
- <p>[<code class="key">direction?</code>](#theme.direction) <code class="symbol">&ldquo;</code><code class="primitive">ltr</code><code class="symbol">&rdquo;</code><code class="symbol"> | </code><code class="symbol">&ldquo;</code><code class="primitive">rtl</code><code class="symbol">&rdquo;</code></p>
...
- <p>[<code class="key">locale?</code>](#theme.locale) <code class="primitive">string</code></p>
...
- <p>[<code class="key">title?</code>](#theme.title) [<code class="type">LocalizedString</code>](#localizedstring)</p>
</Section>
...
<NestedTitle id="theme.direction" Tag="h4" parent="Theme.">direction?</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
**Type** <code class="symbol">&ldquo;</code><code class="primitive">ltr</code><code class="symbol">&rdquo;</code><code class="symbol"> | </code><code class="symbol">&ldquo;</code><code class="primitive">rtl</code><code class="symbol">&rdquo;</code>
</InlineSection>
</Section>
...
<NestedTitle id="theme.locale" Tag="h4" parent="Theme.">locale?</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">string</code>
...
<Section type="parameters">
<InlineSection>
**Type** [<code class="type">LocalizedString</code>](#localizedstring)
</InlineSection>
</Section>
...
<Segment>
<Section type="parameters">
- <p>[<code class="key">theme?</code>](#themeprops.theme) [<code class="type">Theme</code>](#theme)</p>
</Section>
Props for components that accept theme
</Segment>
<NestedTitle id="themeprops.theme" Tag="h4" parent="ThemeProps.">theme?</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
