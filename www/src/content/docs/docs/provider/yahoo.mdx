...
- <p>[<code class="key">query?</code>](#yahooconfig.query) <code class="primitive">Record</code><code class="symbol">&lt;</code><code class="primitive">string</code><code class="symbol">, </code><code class="primitive">string</code><code class="symbol">&gt;</code></p>
