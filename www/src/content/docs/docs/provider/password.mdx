...
- <p>[<code class="key">checkPasswordResetRequired?</code>](#passwordconfig.checkpasswordresetrequired) <code class="primitive">(email: <code class="primitive">string</code>) => <code class="primitive">Promise</code><code class="symbol">&lt;</code><code class="primitive">boolean</code><code class="symbol">&gt;</code></code></p>
...
- <p>[<code class="key">onPasswordChanged?</code>](#passwordconfig.onpasswordchanged) <code class="primitive">(email: <code class="primitive">string</code>) => <code class="primitive">Promise</code><code class="symbol">&lt;</code><code class="primitive">void</code><code class="symbol">&gt;</code></code></p>
...
<NestedTitle id="passwordconfig.checkpasswordresetrequired" Tag="h4" parent="PasswordConfig.">checkPasswordResetRequired?</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">(email: <code class="primitive">string</code>) => <code class="primitive">Promise</code><code class="symbol">&lt;</code><code class="primitive">boolean</code><code class="symbol">&gt;</code></code>
</InlineSection>
</Section>
...
<NestedTitle id="passwordconfig.onpasswordchanged" Tag="h4" parent="PasswordConfig.">onPasswordChanged?</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">(email: <code class="primitive">string</code>) => <code class="primitive">Promise</code><code class="symbol">&lt;</code><code class="primitive">void</code><code class="symbol">&gt;</code></code>
</InlineSection>
</Section>
